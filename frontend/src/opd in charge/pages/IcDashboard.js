...
import AllWaitingPatientList from "../../opd consultation doctor/components/dashboard/AllWaitingPatientList";
import SearchWaitingPatientList from "../../opd consultation doctor/components/dashboard/SearchWaitingPatientList";
import ConsultForm from "../../opd consultation doctor/components/dashboard/ConsultForm";
import PrescriptionForm from "../../opd consultation doctor/components/dashboard/PrescriptionForm";
import ReferForm from "../../opd consultation doctor/components/dashboard/ReferenceForm";
import SuccessNotice from "../../shared/components/ErrorNotice";
import LoadingModal from "../../shared/components/LoadingModal";
import Footer from "../../shared/components/Footer";

class IcDashboard extends Component {
  constructor(props) {
    super(props);
...
export default withRouter(IcDashboard);
