...
import AdmitForm from "../components/dashboard/AdmitForm";
  ...
  setComponent(changeTo) {
    switch (changeTo) {
      ...
      case "waiting_result":
        ...
        break;
      case "admitting":
        this.setState({ currentComponent: "admitting" });
        break;
      default:
        this.setState({ currentComponent: "dashboard" });
    }
        ...
        <div style={{ minHeight: "calc(100vh - 70px" }}>
          ...
          <div style={{ paddingTop: "60px" }}>
            ...
            <Container>
              ...
              {this.state.currentComponent === "admitting" ? (
                <AdmitForm
...
export default withRouter(AdDashboard);
